...
- Frontend [axios react-icons react-toastify redux-toolkit]
- Backend [bcryptjs express-async-handler jsonwebtoken]
- State [redux-toolkit]
- Date: 4th July 2022
...
- MongoDb [Portfolio]
- Frontend [axios material-ui react-google-login redux-toolkit]
- Backend [axios cheerio cors nodemailer]
- State [redux-toolkit]
- Date: 12th July 2022
